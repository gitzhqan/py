...
def central_corridor():
    ...
    print "a Gothon jumps out, red scaly skin, dark grimy teeth, and evil clown castume"
    ...
    def laser_weapon_armory():
        ...
        if guess == code:
            ...
            print "You grad bhe neutron bomb and run as fast as you can to the"
    ...
    def the_bridge():
        ...
        if action == "throw the bomb":
            ...
            print "You then jump back through the door, punch the clase button"
    ...
    def escape_pod():
        ...
        print "the escape pod before the whole ship expldes. It seems like"
